...
Connection: env MYSQL_HOST, MYSQL_PORT, MYSQL_USER, MYSQL_PASSWORD (defaults for local dev).
"""
...
def get_connection():
    # Omit database here so CREATE DATABASE works if retail_banking is new.
